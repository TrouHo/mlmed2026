...
% -------------------- Title --------------------
\title{ECG Heartbeat Classification using Gradient Boosting Clasifier}
...
For heartbeat classification, I employ a gradient boosting model based on decision trees, specifically the \texttt{HistGradientBoostingClassifier} from the scikit-learn library. Gradient boosting builds an ensemble of weak learners in a sequential manner, where each new tree attempts to correct the errors made by the previous ensemble. This method is well suited for tabular data and can capture non-linear relationships between input features.
